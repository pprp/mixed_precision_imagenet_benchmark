...
f_train = open(prefix+"_train.out", "r")
f_val = open(prefix+"_val.out", "r")
...
np.save(prefix+'.npy', np.array(train_acc1))
...
plot_standard(train_x, train_acc1, x_legend="Steps",
              y_legend="Acc1", title="O3: Top1 Accuracy of Training Process")
...
# plot_val(val_x, val_loss, x_legend="Steps", y_legend="Loss",
#          title="O2: Loss of Validation Process")
