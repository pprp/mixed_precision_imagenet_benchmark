...
class ImageNetLightningModel(LightningModule):
    ...
    def add_model_specific_args(parent_parser):  # pragma: no-cover
        ...
        parser.add_argument('-j', '--workers', default=8, type=int, metavar='N',
                            help='number of data loading workers (default: 4)', dest="workers")
...
def run_cli():
    ...
    parent_parser.add_argument('--data-path', metavar='DIR', type=str, default="/media/niu/niu_d/data/imagenet",
